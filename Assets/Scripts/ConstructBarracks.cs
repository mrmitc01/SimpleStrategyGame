...
public class ConstructBarracks : MonoBehaviour
{
    string platformNum;
    ...
    public void BuildBarracks()
    {
        ...
        // Spawn barracks
        float positionY = barracksBlue.transform.position.y;
        float positionX = platformObject.transform.position.x;
        float positionZ = platformObject.transform.position.z;
        Quaternion rotation = barracksBlue.transform.rotation;
        Vector3 position = new Vector3(positionX, positionY, positionZ);
        GameObject newBarracksBlue = Instantiate(barracksBlue, position, rotation);
        newBarracksBlue.name = "Barracks_Blue" + platformNum;
        ...
        gameControl.energyCount -= buildPanel.barracksCost;
